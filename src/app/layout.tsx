...
export const metadata: Metadata = {
  title: "Розроб очек - IT рішення для бізнесу",
  description: "Інноваційна українська IT компанія. Веб-розробка, мобільні додатки, цифрові трансформації",
  keywords: "розроб, IT компанія, веб-розробка, мобільні додатки, Україна, програмування",
  metadataBase: new URL("https://rozrob-ochek.ua"),
  alternates: {
    canonical: "https://rozrob-ochek.ua"
  },
  openGraph: {
    title: "Розроб очек - IT рішення для бізнесу",
    description: "Інноваційна українська IT компанія. Веб-розробка, мобільні додатки, цифрові трансформації",
    url: "https://rozrob-ochek.ua",
    siteName: "Розроб очек",
    type: "website"
  },
  robots: {
    index: true,
